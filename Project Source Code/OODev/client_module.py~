...
class Client :
	...
	def recvAlert(self, thing, state) :
		print( thing, state ) 
		self.displayStates(state) 
...
class View(Client) :
	...
	def displayStates(self, states) :
		os.system('clear')
		print("-------------------------") 
		print("      System Status      ")
		print("-------------------------")
		print("Connections :")
		print("ROBOT 		-", states['robot']) 
		print("CONTROLLER	-", states['controller']) 
		print("VIEWS 		-", states['views']) 
		...
		if states['robot'] :
			...
			print("-------------------------")
			print("Devices :") 
			print(states['devices'])
			print("Device States :") 
			print(states['robot_state'])
